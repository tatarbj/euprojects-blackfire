      ...
      <div class="row">
        ...
        <section class="section <?php print $content_column_class; ?>">
          ...
          <?php
            ...
            $div_title_right = '';
            $div_end = '';
            $previous_next_button_mobile = '';
            $previous_next_button = '';
            if (!empty($node) and $node->type == 'project') {
              $div_project = '<div id="project-content">';
              $div_title_left = '<div class="col-lg-9">';
              $div_title_right = '<div class="col-lg-3">';
              $div_end = '</div>';
         ...
         ?>
          <?php print $div_project; ?>
            <div class="container-fluid page-header__hero-title">
              <div class="row padding-reset">
                <?php print $div_title_left; ?>
                  <?php print drupal_render($previous_next_button_mobile); ?>
                  ...
                  <?php endif; ?>
                <?php print $div_end; ?>
                <?php print $div_title_right; ?>
                  <?php print drupal_render($previous_next_button); ?>
                <?php print $div_end; ?>
              </div>
            </div>
